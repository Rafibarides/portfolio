...
const ALBUM_DATA = {
  ...
  presaveLink: "http://url2734.distrokid.com/ls/click?upn=u001.a0grtTtFNGObbwv02PitCF6-2FcsDAe1n0Iz8ON3EkvDeiOQ63yXLggEvBLyLJtBjwjgHwggAtLqP3OrTazbIM-2FT7aAuj5iofF8RAiRK0YbGiBbWPIaZvZezySgtQEBTrNRAceH4RyRM3p3X1ZIcN06-2B4phqlEtbzWgwtgXnquE3WFZFmAJIOkMudr8LFzd5ZUf-2BVLMmo8RYpVNzzX3lS-2Fpw-3D-3DrfRL_-2BJv9WLoOWM-2FDx35oOyc2VIvzok-2FHNcvRJWxPhyoNaeb8maXzQt4mQ-2BPMvCsYL3EIrU321bel64ZjaxG1lHxB2y9lrcDoFYv3JLWuWhZUlP8K9jHeJfw11SHSrYNmIJIeP-2BceT-2BKovACmhoaUqaLa-2B-2FzzHHgwKheVFgjoz0nkyi6New552OeTjqX1nGrpd4fBeU7DeZFdAWasZ-2FHYe-2FPkDg-3D-3D",
  songs: [
    {
      id: 1,
      title: "In Again",
  ...
  <style>
    ...
    * {
    ...
    .presave-button {
      ...
      background: linear-gradient(135deg, #fc3c44 0%, #d62d35 100%);
      color: #ffffff;
      font-family: 'DM Sans', -apple-system, BlinkMacSystemFont, sans-serif;
      font-size: 0.95rem;
      font-weight: 600;
    ...
    .presave-button:hover {
      ...
      box-shadow: 
        0 8px 25px rgba(252, 60, 68, 0.4),
        0 0 0 1px rgba(255, 255, 255, 0.15) inset;
      background: linear-gradient(135deg, #ff4d55 0%, #e63840 100%);
    }
    
    .presave-button .apple-icon {
      width: 20px;
      height: 20px;
      flex-shrink: 0;
    }
    ...
    <div class="container">
      <header class="album-header" itemscope itemtype="https://schema.org/MusicAlbum">
        ...
        <div class="album-info">
          ...
          <a 
            href="${ALBUM_DATA.presaveLink}"
            target="_blank"
            rel="noopener noreferrer"
            class="presave-button"
          >
